...
monaco.editor.defineTheme('myDarkTheme', {
    ...
    rules: [
        ...
        { "token": "function", "foreground": "dcdcaa" } // Functions in light yellowish color
    ],
    colors: {
        "editor.foreground": "#d4d4d4",                 // Text color
        "editor.background": "#141414",                  // Updated background color
        "editor.selectionBackground": "#3a3d41",         // Selection background color
        "editor.lineHighlightBackground": "#141414",     // Updated highlighting of the current line
        ...
        "editorHoverWidget.background": "#141414",       // Updated background color of the hover widget (tooltips)
...
editor = monaco.editor.create(document.getElementById("container"), {
    ...
    minimap: {
        enabled: false // Disable the minimap if you want a cleaner look
    },
    scrollbar: {
        vertical: 'visible',
        horizontal: 'hidden'
